...
class UpdateLoginDetails extends UseCase<PostApiResponse, UpdateLoginDetailsParams> {
  final UserRemoteRepository userRemoteRepository;

  UpdateLoginDetails({required this.userRemoteRepository});

  @override
  Future<Either<AppError, PostApiResponse>> call(UpdateLoginDetailsParams params) async {
    return await userRemoteRepository.updateLoginDetails(params: params);
  }
}
