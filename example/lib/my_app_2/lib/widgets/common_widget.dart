...
class CommonWidget {
              ...
              children: [
                ...
                container(
                  child: commonText(
                    ...
                    text: text,
                    style: contentTextStyle ?? Theme.of(context).textTheme.bodyBookHeading.copyWith(color: textColor),
                  ),
                ),
                Padding(
  ...
  static Widget textField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        filled: true,
        fillColor: fillColor ?? appConstants.textFiledColor,
  ...
  static Future<List<DateTime>> datePicker({
    ...
    if (isRangeDate) {
      DateTimeRange date = await showRangePickerDialog(
            padding: EdgeInsets.symmetric(horizontal: 12.w),
            context: context,
            maxDate: maxDate ?? DateTime(2025),
            minDate: minDate,
            currentDateTextStyle: Theme.of(context).textTheme.captionBookHeading.copyWith(
                  color: appConstants.buttonTextColor,
                ),
          ) ??
          DateTimeRange(start: DateTime.now(), end: DateTime.now());
      dateList = [date.start, date.end];
    } else {
    ...
    return GestureDetector(
      ...
      child: container(
        ...
        child: child ??
            commonText(
              text: text,
              style: style ?? Theme.of(context).textTheme.bodyMediumHeading.copyWith(color: textColor),
            ),
      ),
    );
  }
  ...
  static Widget locationTextFiled({
    ...
    return container(
      ...
      child: textField(
        ...
        hintColor: appConstants.default6Color,
        issuffixWidget: true,
              ...
              Column(
                ...
                children: [
                  ...
                  commonText(
                    ...
                    style:
                        Theme.of(context).textTheme.overLineMediumHeading.copyWith(color: appConstants.default1Color),
                  ),
                ],
              )
            ],
  ...
  static Widget commonRequiredStatr({required BuildContext context}) {
    return commonText(
      text: TranslationConstants.required_star.translate(context),
  ...
  static String sringToCurrencyFormate({required dynamic text}) {
    return '₹$text';
  }
...
class PhoneNumberFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    if (text.length == 5 && oldValue.text.length < 5) {
      final newText = '$text ';
