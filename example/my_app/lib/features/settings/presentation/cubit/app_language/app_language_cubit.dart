...
class AppLanguageCubit extends Cubit<AppLanguageState> {
  ...
  void loadAppLanguages() {
    ...
    emit(AppLanguageLoadedState(appLanguageList: appLanuageList, selectIndex: 0));
  }

  void changeLanguage({required AppLanguageLoadedState state, required int selectindex}) {
