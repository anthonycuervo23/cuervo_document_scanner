  ...
  Widget commonLanguageBox({
    ...
    return GestureDetector(
      ...
      child: CommonWidget.container(
        ...
        isBorder: appLanguageEntity.isDefault == 1 ? state.selectIndex == index : true,
        // appLanguageEntity.isDefault == 1,
        borderColor: state.selectIndex == index ? appConstants.primary1Color : Colors.transparent,
        child: Padding(
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Visibility(
                    visible: state.selectIndex == index,
